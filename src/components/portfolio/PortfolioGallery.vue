...
<template>
  <section
    class="section section-shell rounded-3xl bg-slate-50 dark:bg-slate-900 border border-slate-200/70 dark:border-slate-800 shadow-lg shadow-slate-900/5 p-6 md:p-8 space-y-6"
  >
      ...
      <div class="section-container">
        ...
        <transition name="gallery" mode="out-in">
          <section v-if="selectedWork" v-inview :key="selectedWork?.id || 'none'" class="mt-6">
            <div class="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-lg p-5 md:p-6">
              <div class="flex items-end justify-between mb-4">
                ...
                <button
                  type="button"
                  class="inline-flex items-center rounded-full border border-slate-200 dark:border-slate-700 px-3 py-2 text-sm text-slate-700 dark:text-slate-100 hover:bg-slate-100 hover:text-slate-900 dark:hover:bg-slate-800 transition"
              ...
              >
                <article
                  ...
                  :key="item.id"
                  class="relative overflow-hidden rounded-xl shadow bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 flex flex-col transition hover:-translate-y-1 hover:shadow-lg border border-slate-200 dark:border-slate-700"
